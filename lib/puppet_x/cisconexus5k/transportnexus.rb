...
class PuppetX::Cisconexus5k::Transportnexus
  ...
  def initialize(certname, options = {})
    ...
    unless @session
      require "puppet_x/cisconexus5k/sshnexus"
      @session = PuppetX::Cisconexus5k::Ssh.new
  ...
  def command(cmd = nil)
    ...
    Puppet.debug("executing command in transport")
    Puppet.debug("*****TIMEOUT****")
    connect
