require 'puppet_x/cisconexus5k/transportnexus'
require 'puppet/provider/network_device'

# This is the base class of all prefetched cisco device providers
class Puppet::Provider::Cisconexus < Puppet::Provider::NetworkDevice
  ...
  def self.transport
    @transport ||= PuppetX::Cisconexus5k::Transportnexus.new(Puppet[:certname])
  end
